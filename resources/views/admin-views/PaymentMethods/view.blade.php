...
@section('title', translate('PaymentMethods'))
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-10">
                ...
                {{ translate('payment Methods_Setup') }}
            </h2>
        </div>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        <table
                            ...
                            <tbody>
                                ...
                                @forelse ($PaymentMethods as $key => $category)
                                    @php
                                        $counter++;
                                    @endphp
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-10">
                                                <a class="btn btn-outline-info btn-sm square-btn "
                                                    ...
                                                    href="{{ route('admin.payment-methods.edit', [$category['id']]) }}">
                                                    <i class="tio-edit"></i>
                                                </a>
                                                <form
                                                    action="{{ route('admin.payment-methods.destroy', $category['id']) }}"
