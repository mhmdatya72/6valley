...
@section('content')
    <div class="content container-fluid">
                    ...
                    @foreach ($languages as $lang)
                        <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" {{ $lang == $defaultLanguage ? 'required' : '' }} name="product_name"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control action-get-request-onchange"
                                    ...
                                    data-url-prefix="{{ url('/admin/products/get-categories?parent_id=') }}"
                                    data-element-id="brand-category-select" data-element-type="select">
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body price-list">
                    <div class="row align-items-end item-price">
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label class="title-color mb-0">{{ translate('unit_price') }}
                                    ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})</label>
                                <input type="number" min="0" step="0.01"
                                    placeholder="{{ translate('unit_price') }}" name="productPrices[0][unit_price]"
                                    class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3 form-group">
                            <label class="title-color mb-0">{{ translate('Sort') }}</label>
                            <input type="number" min="1" step="1" name="productPrices[0][order]"
                                class="form-control" required>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3 form-group">
                            <label class="title-color mb-0">{{ translate('Unit') }}</label>
                            <div class="col-12 row">
                                <select class="col-10 js-example-basic-multiple form-control select-unit"
                                    data-live-search="true" name="productPrices[0][unit]">
                                    @foreach (units() as $unit)
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 form-group" id="numberOfPieces">
                            <label class="title-color mb-0">{{ translate('numberOfPieces') }}</label>
                            <input type="number" min="1" value="1" step="1"
                                placeholder="{{ translate('Quantity') }}" name="prdoctPrice[0][numberOfPieces]"
                                class="form-control" required>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3 form-group">
                            <label class="title-color mb-0">{{ translate('Purchase price') }}</label>
                            <input type="number" min="0" step="0.01"
                                placeholder="{{ translate('Purchase price') }}" value="{{ old('purchase_price') }}"
                                name="prdoctPrice[0][purchase_price]" class="form-control" required>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    ...
                                    <span class="input-label-secondary cursor-pointer" name="prdoctPrice[0][tax]"
                                        data-toggle="tooltip"
                                        title="{{ translate('set_the_tax_calculation_method_from_here._Select_“Include_with_product”_to_combine_product_price_and_tax_on_the_checkout._Pick_“Exclude_from_product”_to_display_product_price_and_tax_amount_separately.') }}">
                                        <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12" id="shipping_cost">
                            ...
                            <textarea placeholder="{{ translate('description') }}" name="prdoctPrice[0][description]" class="form-control"
                                required></textarea>
                        </div>

                        <div class="card-footer">
                            <button type="button" class="btn btn-info add-more"><i class="tio-add"></i>
                                {{ translate('Add More') }}</button>
                            <button type="button" class="btn btn-danger remove-product"><i class="tio-remove"></i>
        ...
        <div class="modal " id="addnewType" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{ translate('Add') }} {{ translate('Unit') }}
                        </h5>
                        ...
                        <div class="row">
                            <form class="col-12" id="unitForm">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="_token" id="unit_name"
                                        value="{{ csrf_token() }}">
                                    <input type="text" class="form-control" name="name" id="unit_name">
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <button id="btn-unitForm" type="button" class="btn btn-primary">Save
                                        changes</button>
                                </div>
                            </form>
                        </div>
                  ...
                  <div class="row align-items-end item-price">
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" step="0.01" placeholder="{{ translate('unit_price') }}"  name="productPrices[` +
                index_list + `][unit_price]" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3 form-group">
                        <label class="title-color mb-0">{{ translate('Sort') }}</label>
                        <input type="number" min="1" step="1" name="productPrices[` + index_list +
                `][order]" class="form-control" required>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3 form-group">
                        <label class="title-color mb-0">{{ translate('Unit') }}</label>
                        <div class="col-12 row">
        ...
        $('#btn-unitForm').on('click', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        $('select.select-unit').append(`<option value="` + name + `">` + name +
                            `</option>`);
