...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="{{ route('vendor.profiles.update', [$vendor->id]) }}" method="post"
                    enctype="multipart/form-data" id="update-profile-form">
                    @csrf
                    <div class="card mb-3 mb-lg-5" id="general-div">
                        <div class="profile-cover">
                            @php($banner = dynamicAsset('public/assets/back-end/img/media/admin-profile-bg.png'))
                        ...
                        <div class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar">
                            <img id="viewer" class="avatar-img"
                                src="{{ getValidImage('storage/app/public/seller/' . $vendor->image, 'backend-profile') }}"
                                alt="{{ translate('image') }}">
                            <label class="change-profile-image-icon" for="custom-file-upload">
                                <img src="{{ dynamicAsset('public/assets/back-end/img/add-photo.png') }}" alt="">
                            </label>
                        </div>

                        <div class="card-header">
                            <div class="d-flex align-items-center gap-3">
                                <div><img src="{{ dynamicAsset('public/assets/back-end/img/icons/user-1.svg') }}"
                                        alt="">
                                </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="text" class="form-control" name="f_name" id="firstNameLabel"
                                                ...
                                                value="{{ old('f_name', $vendor->f_name) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <div class="input-group input-group-sm-down-break">
                                            <input type="text" class="form-control" name="l_name" id="lastNameLabel"
                                                placeholder="{{ translate('ex') }}: {{ translate('ABC') }}"
                                                aria-label=" {{ translate('ABC') }}"
                                                value="{{ old('l_name', $vendor->l_name) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                ...
                <form action="{{ route('vendor.profile.update-addition', [$vendor->id]) }}" method="post"
                    ...
                    <div class="card mb-3 mb-lg-5" id="addition-div">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <div class="input-group input-group-sm-down-break">
                                            <select id="payments" name="payments[]"
                                                class="js-select2-custom form-control" aria-label="Default select example"
                                                multiple>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit" data-message="{{ translate('want_to_update_vendor_info') . '?' }}"
                                    class="btn btn--primary {{ env('APP_MODE') != 'demo' ? 'form-submit' : 'call-demo' }}">{{ translate('save_Changes') }}</button>
                            </div>
                        </div>
                    </div>
