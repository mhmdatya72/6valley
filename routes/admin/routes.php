...
use App\Http\Controllers\Admin\ShopNameController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::resource('admin/payment-methods', PaymentMethodsController::class);
    Route::resource('admin/Shop-Name', ShopNameController::class);
    ...
    Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
        Route::controller(OrderController::class)->group(function () {
            ...
            Route::put('/{id}/order_details_update', 'order_details_update')->name('order_details_update');
    ...
    //Route::resource('admin/payment-methods', PaymentMethodsController::class);
    // Route::get('admin.payment-methods.index', [PaymentMethodsController::class, 'index']);
    // Route::post('admin/payment-methods/store', [PaymentMethodsController::class, 'store']);
    // Route::get('admin/payment-methods/{id}/edit', [PaymentMethodsController::class, 'edit']);
    // Route::post('admin/payment-methods/{id}/update', [PaymentMethodsController::class, 'update']);
    // Route::post('admin/payment-methods', [PaymentMethodsController::class, 'destroy']);
