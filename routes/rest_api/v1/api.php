...
use App\Http\Controllers\RestAPI\v1\PaymentMethodsController;
use App\Http\Controllers\RestAPI\v1\ShopNameController;
...
//  Route::post('paymentMethods', [PaymentMethodsController::class, 'store']);
Route::resource('payment-methods', PaymentMethodsController::class);
//Route::get('payment-methods', [PaymentMethodsController::class, 'index']);
Route::resource('shop-name', ShopNameController::class);
