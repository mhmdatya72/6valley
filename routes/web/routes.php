...
use App\Http\Controllers\Vendor\PaymentMethodsController;
use App\Http\Controllers\Vendor\VendorProfileUpdateController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
// Route::get('vendor/payment-methods', [PaymentMethodsController::class, 'paymentMethods']);
Route::get('/payment-methods', [PaymentMethodsController::class, 'index']);
// Route to update vendor profile - POST method
 Route::post('vendor/profile-update/{id}', [VendorProfileUpdateController::class, 'update'])
     ->name('vendor.profiles.update');
